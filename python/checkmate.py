...
def get_sorted_checkpoints(best_checkpoint_dir, select_maximum_value=True):
...
def get_best_checkpoint(best_checkpoint_dir, select_maximum_value=True):
    best_checkpoints = get_sorted_checkpoints(best_checkpoint_dir, select_maximum_value)
    print( os.path.join(best_checkpoint_dir,  best_checkpoints[0]))
    return os.path.join(best_checkpoint_dir,  best_checkpoints[0])

def get_rand_checkpoint(best_checkpoint_dir, select_maximum_value=True):
    best_checkpoints = get_sorted_checkpoints(best_checkpoint_dir, select_maximum_value)
    random.shuffle(best_checkpoints)
    print( os.path.join(best_checkpoint_dir,  best_checkpoints[0]))
    return os.path.join(best_checkpoint_dir,  best_checkpoints[0])